...
public class DAOGenericoCliente implements Serializable {
     ...
     */
    public DAOGenericoCliente(EntityManager entityManager) {
        super();
    ...
    */
     ...
     *
     * @param first offset o primer resultado de la consulta
     * @param maxResults cantidad de resultados que debe arrojar la consulta
     * @param sortField campo por el que se va a ordernar la consulta
     * @param ascending <code>true</code> en caso de ser ascendente,
     * <code>false</code> si es descendente, y <code>null</code> para no
     * ordernar
     * @param filters mapa con los filtros de la consulta, estos se hacen
     * mediante un like
     ...
     * @param filters opcional, para realizar restricciones en la consulta
     ...
     * @param updatedInstance edidad con la información actualizada
